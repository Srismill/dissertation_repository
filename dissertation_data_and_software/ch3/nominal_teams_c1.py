...
#Example file for nominal subteams simulations
...
params['use_subsets'] = 1
params['sync_merges'] = 1
params['subset_size'] = 1
params['nominal_PB'] = 0

exploration_phase_fraction = 0.01 
max_designs = [1,1,2,3,4] #changes the max designs for the simulator
...
for i in range(len(max_designs)):
    ...
    for k in range(num_tries):
        ...
        test_framework.problem.weights[-1] *= 1 #multiplier for pitch moment weight; 1 for uncoupled, 100 for mixed, 1000 for coupled
...
r_2 = obj_record2
np.save('nominal_c1',obj_record2)
