...
#file identifier 011 is 0.1, 1, file identifier 01 is 0,1
params = {}
...
params['nominal_PB'] = 0
params['VC_agents'] = 6 #number of agents for model problem, 6 for primary figures in ch2
...
r_2 = obj_record2
np.save('model_00_01w_6ag',obj_record2)
